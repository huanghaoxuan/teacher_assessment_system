<template>
  <div>
    ...
    <a-modal
      title="正在修改任职以来所带已毕业班级就业率考研率违纪率情况内容"
      :visible="visible"
      @ok="handleOk"
      okText="确认修改"
      cancelText="取消"
    ...
    showModal() {
      ...
      setTimeout(() => {
        this.form.setFieldsValue({
          ...
          employment: this.editData.employment,
          graduating: this.editData.graduating,
          disciplinaryRate: this.editData.disciplinaryRate,
