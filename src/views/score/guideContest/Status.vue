  ...
  <div style="background:#ECECEC; padding:30px">
    <a-card title="指导学生比赛（毕业设计）获奖">
      ...
      <a-collapse @change="changeActivekey" :bordered="false" accordion>
        <a-collapse-panel header="国际级" key="1">
          <a-collapse>
            <a-collapse-panel header="一等（特等）" key="1-1">
              <p>{{ data.internationalFirstDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="二等" key="1-2">
              <p>{{ data.internationalSecondDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="三等" key="1-3">
              <p>{{ data.internationalThirdDigit }}</p>
            </a-collapse-panel>
          </a-collapse>
        </a-collapse-panel>
        <a-collapse-panel header="国家级" key="2">
          <a-collapse>
        ...
        <a-collapse-panel header="省部级（大区）" key="3">
          <a-collapse>
        ...
        <a-collapse-panel header="市局级" key="4">
          <a-collapse>
        ...
        <a-collapse-panel header="校级" key="5">
          <a-collapse>
            <a-collapse-panel header="一等（特等）" key="5-1">
              <p>{{ data.schoolFirstDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="二等" key="5-2">
              <p>{{ data.schoolSecondDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="三等" key="5-3">
...
export default {
  ...
  mounted() {
    this.axios
      .get(
        "/scoreGuidecontest/selectByPrimaryKey",
        {},
        {
          headers: {
