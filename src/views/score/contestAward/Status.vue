    ...
    <a-card title="竞赛奖">
      ...
      <a-collapse @change="changeActivekey" :bordered="false" accordion>
        <a-collapse-panel header="国家级" key="1">
          <a-collapse>
            <a-collapse-panel header="一等（特等）奖" key="1-1">
              <p>{{ data.countryFirstDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="二等奖" key="1-2">
              <p>{{ data.countrySecondDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="三等奖" key="1-3">
        ...
        <a-collapse-panel header="省部级（大区）" key="2">
          <a-collapse>
            <a-collapse-panel header="一等（特等）奖" key="2-1">
              <p>{{ data.provincialFirstDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="二等奖" key="2-2">
              <p>{{ data.provincialSecondDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="三等奖" key="2-3">
        ...
        <a-collapse-panel header="市局级" key="3">
          <a-collapse>
            <a-collapse-panel header="一等（特等）奖" key="3-1">
              <p>{{ data.cityFirstDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="二等奖" key="3-2">
              <p>{{ data.citySecondDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="三等奖" key="3-3">
        ...
        <a-collapse-panel header="校级" key="4">
          <a-collapse>
            <a-collapse-panel header="一等（特等）奖" key="4-1">
              <p>{{ data.schoolFirstDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="二等奖" key="4-2">
              <p>{{ data.schoolSecondDigit }}</p>
            </a-collapse-panel>
            <a-collapse-panel header="三等奖" key="4-3">
...
export default {
  ...
  mounted() {
    this.axios
      .get(
        "/scoreContestaward/selectByPrimaryKey",
        {},
        {
          headers: {
