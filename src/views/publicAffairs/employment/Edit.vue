    ...
    showModal() {
      ...
      setTimeout(() => {
        this.form.setFieldsValue({
          directEmploymentNumber: this.editData.directEmploymentNumber,
          helpConnectEmploymentNumber: this.editData
            .helpConnectEmploymentNumber,
          participationInEmploymentGuidanceNumber: this.editData
            .participationInEmploymentGuidanceNumber,
          mentoringExaminationCoursesNumber: this.editData
            .mentoringExaminationCoursesNumber,
          helpAdmitEntranceNumber: this.editData.helpAdmitEntranceNumber,
          guideEntrepreneurshipNumber: this.editData
            .guideEntrepreneurshipNumber,
