...
const columns = [
  {
    title: "招生点负责人",
    width: 200,
    dataIndex: "admissionsHeader",
    key: "1",
    fixed: "left"
  },
  { title: "参与招生", dataIndex: "hasAdmission", key: "2", width: 200 },
  { title: "招生表现", dataIndex: "performance", key: "3", width: 200 },
  { title: "招生业绩", dataIndex: "result", key: "4", width: 200 },
  { title: "招生地点", dataIndex: "address", key: "5", width: 200 },
...
export default {
  ...
  methods: {
    ...
    onDelete(key) {
      ...
      this.axios
        .get(
          "/publicaffairsAdmissions/deleteByPrimaryKey",
          {
            params: {
              id: data[key].id
            }
    ...
    showListData(pageNum) {
      this.axios
        .get(
          "/publicaffairsAdmissions/selectByClassTeacher",
          {
            params: {
