...
const columns = [
  ...
  { title: "指导形式", dataIndex: "character", key: "2", width: 200 },
  { title: "获奖级别", dataIndex: "level", key: "3", width: 200 },
  { title: "获奖人数", dataIndex: "winnersNumber", key: "4", width: 200 },
...
export default {
  ...
  methods: {
    ...
    onDelete(key) {
      ...
      this.axios
        .get(
          "/teacheringworkGraduationdesignguide/deleteByPrimaryKey",
          {
            params: {
              id: data[key].id
            }
    ...
    showListData(pageNum) {
      this.axios
        .get(
          "/teacheringworkGraduationdesignguide/selectByClassTeacher",
          {
            params: {
    ...
    showAllListData(pageNum) {
      this.axios
        .get(
          "/teacheringworkGraduationdesignguide/selectAll",
          {
            params: {
              pageNum: pageNum,
              pageSize: 9
