...
const columns1 = [
  ...
  { title: "学分", dataIndex: "credits", key: "2", width: 200 },
  { title: "时长", dataIndex: "hours", key: "3", width: 200 },
  { title: "学生人数", dataIndex: "studentNumber", key: "4", width: 200 },
  { title: "循环次数", dataIndex: "loopsNumber", key: "5", width: 200 },
  {
    title: "实训类型",
...
export default {
  ...
  methods: {
    auditChange(data, statusStr) {
      ...
      this.axios
        .post(
          "/teacheringworkPracticaltrainingguidance/updateByPrimaryKey",
          this.qs.stringify({
            ...data
          }),
          {
    ...
    onDelete(key) {
      ...
      this.axios
        .get(
          "/teacheringworkPracticaltrainingguidance/deleteByPrimaryKey",
          {
            params: {
              id: data[key].id
            }
    ...
    showListData(pageNum) {
      this.axios
        .get(
          "/teacheringworkPracticaltrainingguidance/selectByClassTeacher",
          {
            params: {
