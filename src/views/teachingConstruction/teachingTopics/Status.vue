...
export default {
  ...
  methods: {
    ...
    onDelete(key) {
      ...
      this.axios
        .get(
          "/teachingconstructionTeachingtopics/deleteByPrimaryKey",
          {
            params: {
              id: data[key].id
            }
    ...
    showListData(pageNum) {
      this.axios
        .get(
          "/teachingconstructionTeachingtopics/selectByClassTeacher",
          {
            params: {
    ...
    showAllListData(pageNum) {
      this.axios
        .get(
          "/teachingconstructionTeachingtopics/selectAll",
          {
            params: {
