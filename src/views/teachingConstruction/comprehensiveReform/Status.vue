...
export default {
  ...
  methods: {
    ...
    onDelete(key) {
      ...
      this.axios
        .get(
          "/teachingconstructionComprehensivereform/deleteByPrimaryKey",
          {
            params: {
              id: data[key].id
            }
    ...
    showListData(pageNum) {
      this.axios
        .get(
          "/teachingconstructionComprehensivereform/selectByClassTeacher",
          {
            params: {
    ...
    showAllListData(pageNum) {
      this.axios
        .get(
          "/teachingconstructionComprehensivereform/selectAll",
          {
            params: {
              pageNum: pageNum,
              pageSize: 9
