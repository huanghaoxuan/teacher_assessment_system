...
const columns1 = [
  ...
  { title: "得分", dataIndex: "score", key: "10", width: 200 },
  {
    title: "审核情况",
    dataIndex: "status",
    key: "11",
...
export default {
  ...
  methods: {
    auditChange(data, statusStr) {
      ...
      this.axios
        .post(
          "/teachingconstructionTextbookconstruction/updateByPrimaryKey",
          this.qs.stringify({
            ...data
          }),
          {
    ...
    onDelete(key) {
      ...
      this.axios
        .get(
          "/teachingconstructionTextbookconstruction/deleteByPrimaryKey",
          {
            params: {
              id: data[key].id
            }
    ...
    showListData(pageNum) {
      this.axios
        .get(
          "/teachingconstructionTextbookconstruction/selectByClassTeacher",
          {
            params: {
    ...
    showAllListData(pageNum) {
      this.axios
        .get(
          "/teachingconstructionTextbookconstruction/selectAll",
          {
            params: {
              pageNum: pageNum,
              pageSize: 9
