...
const columns = [
  ...
  { title: "得分", dataIndex: "score", key: "12", width: 200 },
  {
    title: "审核情况",
    dataIndex: "status",
    key: "13",
...
export default {
  ...
  methods: {
    auditChange(data, statusStr) {
      ...
      this.axios
        .post(
          "/scientificresearchLongitudinaltopicsproject/updateByPrimaryKey",
          this.qs.stringify({
            ...data
          }),
          {
    ...
    onDelete(key) {
      ...
      this.axios
        .get(
          "/scientificresearchLongitudinaltopicsproject/deleteByPrimaryKey",
          {
            params: {
              id: data[key].id
            }
    ...
    showListData(pageNum) {
      this.axios
        .get(
          "/scientificresearchLongitudinaltopicsproject/selectByClassTeacher",
          {
            params: {
